...
<br>
  <br>
<div class="come">Selamat Datang Di Aplikasi Di Perpustakaan</div>
<br>
<table cellpadding="10" cellspacing="10" align="center" class="bord">
  <tr>
    <td>
      ...
      <td>
        <a href="pusat/pustaka/daftar.php"><img src="img/pustaka.jpg" width="150" height="150">
        <br>
        <a href="pusat/pustaka/daftar.php"><center>Pustaka</a></td>
        <td>
        <a href="pusat/pustakawan/daftar.php"><img src="img/pustakawan.jpg" width="200" height="150">
        <br><a href="pusat/pustakawan/daftar.php"><center>Pustakawan</a>
        </td>
        <td>
        <a href="pusat/transaksi/daftar.php"><img src="img/transaksi.jpg" width="150" height="150">
...
<footer>
 ...
 <p class="mail">Email : ryanrahmatkurniawan17@gmail.com</p>
</footer>
